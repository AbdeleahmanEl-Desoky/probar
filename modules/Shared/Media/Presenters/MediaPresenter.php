...
class MediaPresenter
{
    ...
    // 'files' => MediaPresenter::collection($this->qualification->getMedia('upload_Qualification')), //array

    // $firstMedia = $this->qualification->getFirstMedia('upload_Qualification'); //object
